...
namespace CSM.Migrations
{
    ...
    [Migration("20231027200547_CreateDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSM.DataModels.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSM.DataModels.Employe", b =>
                {
            ...
            modelBuilder.Entity("CSM.DataModels.Parcel", b =>
                {
            ...
            modelBuilder.Entity("CSM.DataModels.Price", b =>
                {
            ...
            modelBuilder.Entity("CSM.DataModels.Recipient", b =>
                {
            ...
            modelBuilder.Entity("CSM.DataModels.Shipment", b =>
                {
            ...
            modelBuilder.Entity("CSM.DataModels.Shipment", b =>
                {
                    b.HasOne("CSM.DataModels.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSM.DataModels.Employe", "Shipper")
                        .WithMany()
                        .HasForeignKey("EmployeId");

                    b.HasOne("CSM.DataModels.Parcel", "Parcel")
                        .WithMany()
                        .HasForeignKey("ParcelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSM.DataModels.Recipient", "Recipient")
                        .WithMany()
